...
public:
    ...
    static void Write(std::string message, ConsoleColor foreColor, ConsoleColor backColor);
    static void WriteLine(std::string message);
    static void WriteLine(std::string message, ConsoleColor foreColor, ConsoleColor backColor);
